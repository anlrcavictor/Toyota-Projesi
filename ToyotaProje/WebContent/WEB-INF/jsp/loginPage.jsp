...
<title>Seyahat Sistemi Giriş</title>
</head>
<body>
	...
	<section class="container">
		...
		<form:form  modelAttribute="newLogin" class="form-horizontal" method="post">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="sicilNo">Şifre</label>
					<div class="col-md-2">
				...
				<div class="form-group">
					<div>
						<input type="submit" id="btnAdd" class="btn btn-primary" value ="Giriş"/>
					</div>
				</div>
				</div>
