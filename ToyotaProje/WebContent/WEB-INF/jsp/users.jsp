						...
						<table id="example" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<c:forEach items="${allUsers}" var="user">
									<tr>
										<td><c:out value="${user.kullaniciAdi}" /></td>
										<td><c:out value="${user.bolum}" /></td>
										<td><c:out value="${user.mudurAdi}" /></td>
										<td><c:out value="${user.rol}" /></td>
										<td><c:out value="${user.seyahatSistemi}-${user.bilgilendirmeGunu} " /></td>
										<td><a
