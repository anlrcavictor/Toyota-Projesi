...
<body>
	...
	<section class="container">
		...
		<form:form  modelAttribute="updateTravel" class="form-horizontal" method="post">
			<fieldset>
				<legend>Seyahat Düzenle</legend>
				
				<form:hidden path="id" />
				
				<div class="form-group">
					<label class="control-label col-lg-2" for="seyahatYeri">Kullanıcı</label>
					<div class="col-md-3">
						<form:input id="kullaniciAdi" path="kullaniciAdi" type="text" class="form:input-large form-control" readonly="true"/>
					</div>
				</div>	
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="maliyet">Seyahat Maliyeti</label>
					<div class="col-md-2">
						<div class="form:input-prepend">
							<form:input id="maliyet" path="maliyet" type="text" class="form-control"/>
						</div>
					</div>
				</div>	
				...
				<div class="col-md-2">
					<a href="${pageContext.request.contextPath}/admin/listTravel" class="btn btn-info"
						type="button">İptal</a>
				</div>
